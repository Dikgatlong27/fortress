  ...
  return (
    <div>
        <div id='social__links' className='app__contactUs-social_socialLinks flex__center'>
          ...
          <a href='https://wa.me/27676228529' target='_blank' rel='noreferrer'><FaWhatsapp color='white' size={35} /></a>
        </div>
        <div className='app__contactUs-social_socialLinks flex__center' id='social__links-mobile'>
          ...
          <a href='https://wa.me/27676228529' target='_blank' rel='noreferrer'><FaWhatsapp color='white' size={25} /></a>
        </div>
    </div>
  )
}
